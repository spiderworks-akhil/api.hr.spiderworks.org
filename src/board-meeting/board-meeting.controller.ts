...
@Controller('board-meeting')
export class BoardMeetingController {
  constructor(private readonly service: BoardMeetingService) {}
  ...
  async create(@Body() dto: CreateBoardMeetingDto) {
  ...
  async update(
    ...
    @Body() dto: UpdateBoardMeetingDto,
  ) {
